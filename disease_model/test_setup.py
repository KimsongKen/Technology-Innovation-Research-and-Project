...
REQUIRED_PATHS = [
    ...
    os.path.join(BASE, "data", "test_results.json"),
]
...
def test_prediction():
    ...
    # Group rare diseases to match 02_disease_prediction.py training
    y = df["diseases"]
...
def test_json_output():
    import json
    with open(os.path.join(BASE, "data", "test_results.json")) as f:
        data = json.load(f)
